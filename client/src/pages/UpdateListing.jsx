          ...
          <div className='flex flex-wrap gap-6'>
            <div className='flex items-center gap-2'>
              <input
                ...
                max='10'
                required
                className='p-3  -gray-300 rounded-lg'
                onChange={handleChange}
        ...
        <div className='flex flex-col flex-1 gap-4'>
          ...
          <div className='flex gap-4'>
            <input
              ...
              className='p-3  -gray-300 rounded w-full'
              type='file'
              id='images'
              accept='image/*'
              multiple
            ...
            <button
              ...
              className='p-3 text-green-700  -green-700 rounded uppercase hover:shadow-lg disabled:opacity-80'
            >
